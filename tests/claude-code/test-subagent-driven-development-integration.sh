...
mkdir -p src test docs/maestro/plans

# Create a simple implementation plan
cat > docs/maestro/plans/implementation-plan.md <<'EOF'
...
I want you to execute the implementation plan at docs/maestro/plans/implementation-plan.md using the subagent-driven-development skill.
...
PROMPT="Execute the implementation plan at docs/maestro/plans/implementation-plan.md using the subagent-driven-development skill.
...
if grep -q '"name":"Skill".*"skill":"maestro:subagent-driven-development"' "$SESSION_FILE"; then
