...
#   $OPENCODE_CONFIG_DIR/maestro/             ← package root
#   $OPENCODE_CONFIG_DIR/maestro/skills/      ← skills dir (../../skills from plugin)
#   $OPENCODE_CONFIG_DIR/maestro/.opencode/plugins/maestro.js ← plugin file
#   $OPENCODE_CONFIG_DIR/plugins/maestro.js   ← symlink OpenCode reads

SUPERPOWERS_DIR="$OPENCODE_CONFIG_DIR/maestro"
SUPERPOWERS_SKILLS_DIR="$SUPERPOWERS_DIR/skills"
SUPERPOWERS_PLUGIN_FILE="$SUPERPOWERS_DIR/.opencode/plugins/maestro.js"
...
cp "$REPO_ROOT/.opencode/plugins/maestro.js" "$SUPERPOWERS_PLUGIN_FILE"

# Register plugin via symlink (what OpenCode actually reads)
mkdir -p "$OPENCODE_CONFIG_DIR/plugins"
ln -sf "$SUPERPOWERS_PLUGIN_FILE" "$OPENCODE_CONFIG_DIR/plugins/maestro.js"
...
echo "Maestro dir:      $SUPERPOWERS_DIR"
echo "Skills dir:           $SUPERPOWERS_SKILLS_DIR"
echo "Plugin file:          $SUPERPOWERS_PLUGIN_FILE"
echo "Plugin registered at: $OPENCODE_CONFIG_DIR/plugins/maestro.js"
