...
const SUPERPOWERS_VERSION = readMaestroVersion();
const SUPERPOWERS_BRAND_IMAGE_URL = 'https://primeradiant.com/brand/maestro-visual-brainstorming-logo.png';
...
function brandMarkup() {
  ...
  const text = SUPERPOWERS_TELEMETRY_DISABLED
    ? 'Prime Radiant Maestro v' + version
    : 'Maestro v' + version;
